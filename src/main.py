...
from views.forgotpass import ForgotPasswordWindow
...
class DocumentRequestSystem:
    ...
    def initialize_database(self):
        ...
        try:
            from database.init_database import initialize_system_database
    ...
    def login_success_callback(self, user_data, user_type):
        ...
        # Admin, Registrar, and Cashier all go to admin dashboard
        if user_type in ['admin', 'registrar', 'cashier']:
            self.show_admin_dashboard()
        else:
            # Students go to home window
            self.show_home()
